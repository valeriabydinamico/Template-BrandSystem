...
export default function Frame() {
  return (
    <div className="bg-gradient-to-l content-stretch flex flex-col from-[#ff9233] items-start justify-between overflow-clip p-[2px] relative rounded-[8px] size-full to-[#e65719]">
      <ColorCard />
      <Paragraph7 />
    </div>
  );
