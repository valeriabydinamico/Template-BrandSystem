function Paragraph() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[20px] text-black whitespace-nowrap">Soft</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="bg-[#e6eef8] content-stretch drop-shadow-[0px_4px_2px_rgba(0,39,90,0.1)] flex flex-col items-start justify-center px-[8px] py-[12px] relative rounded-[6px] shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#16181d] text-[12px] whitespace-nowrap">color/primitive/green/soft</p>
    </div>
  );
}
...
export default function Frame() {
  return (
    <div className="bg-[#ecfdf3] content-stretch flex flex-col items-center overflow-clip p-[2px] relative rounded-[8px] size-full">
      <ColorCard />
      <Paragraph7 />
    </div>
  );
